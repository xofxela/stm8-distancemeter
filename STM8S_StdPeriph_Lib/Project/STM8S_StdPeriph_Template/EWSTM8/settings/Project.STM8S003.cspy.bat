...
"C:\Program Files (x86)\IAR Systems\Embedded Workbench 8.0\common\bin\cspybat" -f "C:\Users\admin\Documents\STM8S_Encoder_release\STM8S_StdPeriph_Lib\Project\STM8S_StdPeriph_Template\EWSTM8\settings\Project.STM8S003.general.xcl" "--debug_file=%~1" --backend -f "C:\Users\admin\Documents\STM8S_Encoder_release\STM8S_StdPeriph_Lib\Project\STM8S_StdPeriph_Template\EWSTM8\settings\Project.STM8S003.driver.xcl" 
